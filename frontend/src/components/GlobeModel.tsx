...
export function GlobeDemo() {
    ...
    <div className="max-w-7xl flex flex-col mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        <motion.div
            initial={{
                opacity: 0,
                y: 20,
